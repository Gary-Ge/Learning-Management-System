...
@Data
public class UpdateVideoSectionVo {
    @Schema(description = "The title of this video section", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String title;

    @Schema(description = "The description of this video section", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
